...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
	<div class="max-w-2xl mx-auto">
		<h1 class="text-4xl md:text-5xl font-bold text-neutral-900 mb-8">Get in Touch</h1>
		...
		<div class="space-y-8">
			<div class="bg-white border border-neutral-200 rounded-lg p-8">
				...
				<a 
					...
					class="inline-flex items-center gap-2 text-lg font-medium text-neutral-900 hover:text-neutral-700 transition-colors"
				>
			...
			<div class="bg-neutral-50 border border-neutral-200 rounded-lg p-8">
				<h2 class="text-xl font-semibold text-neutral-900 mb-4">What to Contact About</h2>
