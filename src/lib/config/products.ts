...
export const products: Product[] = [
	{
		...
		status: 'Building',
		shortDescription: 'Monitor X and LinkedIn conversations in real-time. Find relevant discussions about your topics of interest, get AI-drafted responses ready to review, edit, and send. Plug into communities without manual monitoring.',
	...
	},
	{
		...
		title: 'OpsPilot',
		status: 'Building',
		shortDescription: 'SMBs will be able to run their entire business with the operational intelligence previously available only to enterprises with dedicated accounting, finance, support, engineering, sales & marketing, and operations teams.',
